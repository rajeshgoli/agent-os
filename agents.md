...
- `sm send` quoting safety: if `msg` contains backticks or `$()`, do **not** wrap it in double quotes (zsh will perform command substitution). Use single quotes or pass message text via heredoc/file content.
